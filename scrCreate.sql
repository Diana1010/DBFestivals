...
CREATE TABLE IF NOT EXISTS `fest`.`Contact_info` (
  ...
  INDEX `fk_Contact_info_employee1_idx` (`employee_ID` ASC) VISIBLE,
  INDEX `fk_Contact_info_organizer1_idx` (`organizer_id` ASC) VISIBLE,
  INDEX `contactInfo` (`firstname` ASC, `surname` ASC) VISIBLE,
  CONSTRAINT `fk_Contact_info_employee1`
    FOREIGN KEY (`employee_ID`)
    REFERENCES `fest`.`employee` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Contact_info_organizer1`
...
-- -----------------------------------------------------
-- Table `fest`.`companyr_has_employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fest`.`companyr_has_employee` (
